  ...
  return (
    <main className="min-h-screen bg-midnight">
            ...
            <div className="bg-charcoal border border-charcoal rounded-2xl p-8 flex flex-col items-center gap-6">
              ...
              {whatsappPhone && (
                <a
                  ...
                  className="inline-block bg-green-500 text-white font-bold rounded-full py-4 px-10 text-lg tracking-wide hover:bg-green-600 hover:scale-105 transition-all duration-200 shadow-lg"
                >
                  {t('whatsappCta')}
                </a>
              )}
              ...
              <div className="flex items-center justify-center gap-6">
                {socialLinks.instagram && (
                  <a
                    ...
                    className="w-14 h-14 bg-charcoal border border-charcoal rounded-full flex items-center justify-center text-turquoise hover:text-lime hover:border-lime/30 transition-all"
                  >
      ...
      <section className="py-16 px-6 bg-charcoal/30">
        <ScrollReveal>
          <div className="max-w-lg mx-auto text-center">
            <h2 className="font-bebas-neue text-3xl text-offwhite tracking-widest mb-4">
              {t('hoursTitle')}
            </h2>
