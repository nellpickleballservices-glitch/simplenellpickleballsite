  ...
  return (
    <main className="min-h-screen bg-midnight">
      ...
      <section className="relative flex flex-col items-center justify-center min-h-screen px-6 text-center overflow-hidden">
        ...
        {/* Main headline */}
        <h1 className="relative z-10 font-bebas-neue text-[clamp(4rem,14vw,9rem)] leading-none tracking-widest text-offwhite mb-4">
          {t('heroHeadline')}
        </h1>

        {/* Club name accent line */}
        <p className="relative z-10 font-bebas-neue text-[clamp(1.5rem,5vw,3rem)] text-lime tracking-[0.3em] uppercase mb-6">
          {t('title')}&nbsp;{t('subtitle')}
        </p>

        {/* Sub-headline */}
        <p className="relative z-10 text-offwhite/70 text-base sm:text-lg max-w-xl leading-relaxed mb-10">
          {t('heroSubheadline')}
        </p>
        ...
        <Link
          href="/signup"
          className="relative z-10 inline-block bg-lime text-midnight font-bold rounded-full py-4 px-12 text-lg tracking-wide hover:bg-sunset hover:scale-105 transition-all duration-200 shadow-lg shadow-lime/20"
        >
          {t('heroCta')}
        </Link>

        {/* Scroll hint */}
        <div aria-hidden="true" className="absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 opacity-30">
      ...
      <section className="py-24 px-6 bg-midnight">
        <div className="max-w-5xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-offwhite/60 text-base sm:text-lg max-w-lg mx-auto">
      ...
      <section className="py-24 px-6 bg-charcoal/40">
        <div className="max-w-4xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-offwhite/60 text-base sm:text-lg">
              {t('plansSubheading')}
            </p>
          </div>
            ...
            <article className="relative flex flex-col rounded-2xl border-2 border-lime bg-midnight p-8 shadow-xl shadow-lime/10">
              ...
              <div className="mt-4">
                ...
                <div className="flex items-end gap-1 mb-8">
                  ...
                  <span className="text-offwhite/50 text-lg mb-2">
                    {t('planVipPer')}
                  </span>
                </div>
              ...
              <div className="mt-auto">
                <Link
                  href="/signup"
                  className="block w-full text-center bg-lime text-midnight font-bold rounded-full py-3.5 text-base tracking-wide hover:bg-sunset hover:scale-[1.02] transition-all duration-200"
                >
                  {t('planVipCta')}
                </Link>
              </div>
            ...
            <article className="flex flex-col rounded-2xl border border-charcoal bg-charcoal p-8">
              ...
              <ul className="flex flex-col gap-3 mb-10">
                {[
                  ...
                  <li key={feature} className="flex items-center gap-3 text-offwhite/60 text-sm">
                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor" className="w-5 h-5 text-offwhite/30 shrink-0" aria-hidden="true">
                      <path fillRule="evenodd" d="M16.704 4.153a.75.75 0 01.143 1.052l-8 10.5a.75.75 0 01-1.127.075l-4.5-4.5a.75.75 0 011.06-1.06l3.894 3.893 7.48-9.817a.75.75 0 011.05-.143z" clipRule="evenodd" />
                    </svg>
                    {feature}
                  </li>
      ...
      <section className="relative py-28 px-6 overflow-hidden bg-midnight">
        ...
        <div className="relative z-10 max-w-3xl mx-auto text-center flex flex-col items-center gap-6">
          ...
          <p className="text-offwhite/60 text-base sm:text-lg max-w-xl">
            {t('ctaSubheadline')}
          </p>
          <Link
            href="/signup"
